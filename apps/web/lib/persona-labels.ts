...
export const PERSONA_DISPLAY: Record<string, { name: string; description: string }> = {
  persona_a_family_with_mortgage: {
    ...
    description: "זוג שכיר עם שני ילדים, משכנתה, וביטוח חיים קיים בסיסי.",
  },
  persona_b_self_employed_single: {
    name: "עצמאי רווק",
    description: "עצמאי, רווק, ללא תלויים, ללא כיסוי ביטוחי קיים, הכנסה לא סדירה.",
  },
  persona_c_young_couple_planning_family: {
    name: "זוג צעיר המתכנן משפחה",
    description: "זוג נשוי צעיר, טרם הביא ילדים, כיסוי מודולי בריאות לא ידוע.",
  },
  persona_d_near_retiree: {
    name: "זוג לקראת פרישה",
    description: "זוג לקראת פרישה, נכסים גבוהים, דגש על יכולת מימון עצמי לסיעוד.",
  },
  persona_e_prd_worked_example: {
    name: "דוגמה מלאה",
    description: "דוגמה מקיפה לזוג בגילאי 40/38 עם שני ילדים ומשכנתה, הממחישה את כל שלבי החישוב.",
  },
};
